...
export default {
  ...
  SIGNIN_HEADING: 'Continue With Instant Build',
  SIGNIN_SUBHEADING: 'To use Instant Build you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Instant Build, you agree to the collection of usage data for analytics.',
